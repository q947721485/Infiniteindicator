...
import com.qdd2977.infiniteindicator.indicator.PageIndicator;
import com.qdd2977.infiniteindicator.indicator.RecyleAdapter;
import com.qdd2977.infiniteindicator.loader.ImageLoader;
import com.qdd2977.infiniteindicator.page.Page;
import com.qdd2977.infiniteindicator.salvage.RecyclingPagerAdapter;
...
public class InfiniteIndicator extends RelativeLayout implements RecyclingPagerAdapter.DataChangeListener {
    ...
    public void setPageTransformer(boolean b,ViewPager.PageTransformer p){
        if (mViewPager!=null)
            mViewPager.setPageTransformer(b, p);
    }
